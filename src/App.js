          ...
          <div className="flex flex-col items-center gap-6">
            ...
            >
              <input
                ...
                className="w-[350px]"
              />
              <button type="submit" className="py-2 border hover:text-orange-600 font-semibold px-8">
                join
              </button>
            </form>
          </div>
          <div className="grid grid-cols-3 place-items-center gap-2 mt-12">
            {roomsList.map((name) => (
              <div
                ...
                className={`hover:scale-110 duration-100 cursor-pointer border p-2 rounded shadow-xl w-[200px] h-24 ${name.color} text-white font-semibold`}
              >
                {"#" + name.name}
              </div>
            ))}
